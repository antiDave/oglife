    ...
    <div class="col-lg-5">
        ...
        <div class="xzoom-container">
            <img class="quick-zoom" id="xzoom-magnific1"
                 src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:($product->photo ? asset('assets/images/products/'.$product->photo) : asset('assets/images/products/'.$gs->prod_image))}}"
                 xoriginal="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:($product->photo ? asset('assets/images/products/'.$product->photo) : asset('assets/images/products/'.$gs->prod_image))}}"/>
            <div class="xzoom-thumbs">

                <div class="quick-all-slider">

                    <a href="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:($product->photo ? asset('assets/images/products/'.$product->photo) : asset('assets/images/products/'.$gs->prod_image))}}">
