                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <a href="#" class="prod-item item">            
                                            <div class="prod-init">
                                                <div class="prod-top">
                                                    <h2 class="prod-name" style="color: {{ $colorsetting_style2 && $colorsetting_style2->title_color? $colorsetting_style2->title_color: '#333333' }}">Electric Nail</h2>
                                                </div> 
                                                
                                                <p class="prod-tag">
                                                    <span class="sale" style="background-color: {{ $colorsetting_style2 && $colorsetting_style2->tag_bg_color? $colorsetting_style2->tag_bg_color : '#84a45a' }}; color: {{ $colorsetting_style2 && $colorsetting_style2->tag_color? $colorsetting_style2->tag_color: '#000000' }}">Electric DAB RIG</span>
                                                </p>
                                            ...
                                            <img class="prod-image" src="{{ asset('assets/images/product-view-style1.png') }}" alt="">
                                        </a>
                                    </div>
                                </div>
