...
<head>
    ...
    @php
        $is_bitcoin = FALSE;
        $is_another_coin = FALSE;
        if($gs->is_currency == 1) {
            if(Session::has('currency')) {
                if(DB::table('currencies')->where('id','=',Session::get('currency'))->first()->name == 'Bitcoin') {
                    $is_bitcoin = TRUE;
                } else {
                    if(DB::table('currencies')->where('id','=',Session::get('currency'))->first()->name != 'USD') {
                    $is_another_coin = TRUE;
                }
                }
            }
        }
...
@endif
    ...
    @if(isset($age_no_setted) && !isset($check21))
                            ...
                            <div class="form-forgot-pass">
                                <div class="left">
                                    ...
                                    <label for="terms_condition">
                                        <a href="{{ route('front.terms-condition') }}" target="_blank" style="color:white">
            ...
            <div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
                <nav hidden>
                    ...
                    <ul class="menu">
                        ...
                        @endif
                        <li><a href="{{ route('front.strain') }}">Strains</a></li>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="footer-widget info-link-widget">
                    ...
                    <ul class="link-list">
                        ...
                        <li>
                            <a href="{{ route('front.aboutus') }}" style="color: {{ $gs->footer_text_color }}">
                                <i class="fas fa-angle-double-right" style="color: {{ $gs->footer_text_color }}"></i>About Us
                            </a>
                        </li>
                        ...
                        @foreach(DB::table('pages')->where('footer','=',1)->get() as $data)
                            @if($data->slug == 'terms')
                            <li>
                                <a href="{{ route('front.terms-condition') }}" style="color: {{ $gs->footer_text_color }}">
...
<div class="modal fade" id="qtyview" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog qtyview-modal modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container qtyview-modal" style="display: flex;">
                    <input type="hidden" id="qtyprodid">
                    <input 
                    type="number" 
                    ...
                    id="qtyvalue"
                    style="width: 80%"
                    ><label class="btn btn-success" id="qtyview-ok-btn" style="width: 20%">OK</label>
                </div>
            </div>
        </div>
    </div>
