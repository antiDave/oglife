                            ...
                            <div class="edit-info-area">
                                @php
                                    ...
                                    if($flag>0) {
                                        ...
                                        $exprire_date_string = date("F j, Y", strtotime($exprire_date));

                                        $exprire_date = new DateTime($exprire_date_string);

                                        $dteDiff = $now->diff($exprire_date)->days;

                                @endphp

                                        @if($dteDiff <= 30) 
                                        <div class="alert alert-warning" role="alert">
                                            Good until {{$exprire_date_string}}
                                        </div>
                                        @endif
