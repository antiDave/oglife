        ...
        @foreach ($solo_products as $key => $solo_prod)
            ...
            <a href="{{ route('front.product', $solo_prod->slug) }}" class="prod-item item">            
                <div class="prod-init">
                    ...
                    <p class="prod-price" style="bottom:20px; color: {{ $colorsetting_style2 && $colorsetting_style2->price_color? $colorsetting_style2->price_color: '#333333' }}">
                        {{ $solo_prod->showPrice() }} 
                        <br>
                ...
                <div class="info">
                        ...
                        <p class="prod-name" style="color: {{ $colorsetting_style2 && $colorsetting_style2->sub_detail_color? $colorsetting_style2->sub_detail_color : '#333333' }}">
                            {{ $solo_prod->showName() }}
                        </p>
