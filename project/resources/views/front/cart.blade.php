                                    ...
                                    @foreach($products as $product)
                                        ...
                                        <tr class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}">
                                            ...
                                            <td class="unit-price quantity">
                                                <p id="prct2{{$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])}}">
                                                ...
                                                @if($product['item']['type'] == 'Physical')
                                                    ...
                                                    <div class="qty">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <span class="qtminus1 reducing-c" data-href="{{route('product.cart.reducebyone')}}">
                                                            ...
                                                            <li>
                                                                <span class="qtplus1 adding-c" data-href="{{route('product.cart.addbyone')}}">
