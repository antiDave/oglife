...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        Route::get('/orders/needhelp', 'Admin\OrderController@needhelp')->name('admin-order-needhelp');
        ...
        Route::post('/order/{id}/editprice', 'Admin\OrderController@editprice')->name('admin-order-editprice');
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        Route::get('/users/cod/{id1}/{id2}', 'Admin\UserController@cod')->name('admin-user-cod');
...
// ************************************ FRONT SECTION **********************************************
    ...
    Route::post('/distance', 'Front\FrontendController@calc_distance')->name('front.distance');
    ...
    Route::post('/webhooks', 'Front\FrontendController@tawkhooks')->name('front.tawkhooks');
    ...
    Route::get('/strain/inventory/{id}', 'Front\FrontendController@strain_inventory')->name('front.strains.inventory');
    ...
    Route::get('/strains/datatables', 'Front\FrontendController@strain_datatables')->name('front.straindatatable'); //JSON REQUEST
    ...
    Route::get('/aboutus', 'Front\FrontendController@aboutus')->name('front.aboutus');
    ...
    Route::get('/addbyone', 'Front\CartController@addbyone')->name('product.cart.addbyone');
    Route::get('/reducebyone', 'Front\CartController@reducebyone')->name('product.cart.reducebyone');
    ...
    Route::post('/wiretransfer', 'Front\CheckoutController@wireTransfer')->name('wiretransfer.submit');
    Route::post('/need-help', 'Front\CheckoutController@needHelp')->name('needhelp.submit');
    Route::get('/need-view', 'Front\CheckoutController@needHelpView')->name('needhelp.view');


    Route::post('/greenbuck', 'Front\CheckoutController@greenbuck')->name('greenbuck.submit');
    Route::post('/pre-greenbuck', 'Front\CheckoutController@pregreenbuck')->name('greenbuck.pre');
    Route::get('/check-greenbuck', 'Front\CheckoutController@checkgreenbuck')->name('greenbuck.check');
    Route::post('/webhook-greenbuck', 'Front\CheckoutController@webhookgreenbuck')->name('greenbuck.webhook');
